...
export default {
  ...
  methods : {
    ...
    savecb(){
      ...
      this.$store.dispatch('ndsingle/editlscbreaker', this.circuitbreaker)
      this.cancelcb()
    },
    savewire(){
      // console.log(this.twolinewire)
      this.$store.dispatch('ndsingle/editlsmainfeeder', this.twolinewire)
      this.cancelcb()
    }
  },
  computed : {
    ...mapGetters({
      ...
      loadsummary:              'ndsingle/getloadsummary',
