...
export default {
  ...
  computed : {
    ...mapGetters({
        ...
        getnav_voltage_drop:    'userdata/getnav_voltage_drop',
        getsupply_to_branch:    'userdata/getsupply_to_branch'
    })
  },
  methods : {
    calculatemainfeeder(){
        this.$store.dispatch('userdata/voltagedropmainfeeder', this.voltagedrop.length)
    },
    calculatesupplytobranch(){
        // console.log(this.supplytobranch)
        this.$store.dispatch('userdata/supplytobranch', this.supplytobranch)
    }
  }
}
</script>
