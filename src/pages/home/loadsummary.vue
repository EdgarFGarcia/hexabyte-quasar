...
export default {
  ...
  methods : {
    ...
    savecb(){
      ...
      this.$store.dispatch('userdata/editlscbreaker', this.circuitbreaker)
      this.cancelcb()
    },
    savewire(){
      // console.log(this.twolinewire)
      this.$store.dispatch('userdata/editlsmainfeeder', this.twolinewire)
      this.cancelcb()
    }
  },
  computed : {
    ...mapGetters({
      ...
      loadsummary:              'userdata/getloadsummary',
